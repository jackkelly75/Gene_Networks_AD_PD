...
#import data
setwd("E:/Network analysis/Network Analysis AD/2 Control, AD and MCI seperately/2 AD")
...
n.iterations=400
meg = 0
job.path = "E:/Network analysis/Network Analysis AD/4 k-means correction seperate networks/2 AD"
tom.matrix=TOM
plot.evolution=TRUE
plot.go=FALSE
debug=NULL
net.type="signed"
final.net="E:/Network analysis/Network analysis AD/4 k-means correction seperate networks/2 AD/All Data.10.signed.it.100.rds"
min.genes.for.grey=20

cat("Working with",nrow(expr.data),"samples and",ncol(expr.data),"genes\n")
##Working with 245 samples and 13661 genes
...
#The network includes 13661 genes and  29 modules
...
#############################################
net.label = "AD Data genes Exhanged in k-means adjustment"
g.changes = NULL
n = length(partitions)
for(index in 1:(n-1)){
