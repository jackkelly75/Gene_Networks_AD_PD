...
# import data
setwd("E:/Network analysis/Network Analysis AD/2 Control, AD and MCI seperately/1 Control")
...
expr.data = CTLdatExpr
n.iterations=400
meg = 0
job.path = "E:/Network analysis/Network Analysis AD/4 k-means correction seperate networks/1 Control"
tom.matrix=TOM
plot.evolution=TRUE
plot.go=FALSE
debug=NULL
net.type="signed"
final.net="E:/Network analysis/Network Analysis AD/4 k-means correction seperate networks/1 Control/All Data.10.signed.it.100.rds"
min.genes.for.grey=20

cat("Working with",nrow(expr.data),"samples and",ncol(expr.data),"genes\n")
##Working with 182 samples and 13661 genes
...
#The network includes 13661 genes and  58 modules
