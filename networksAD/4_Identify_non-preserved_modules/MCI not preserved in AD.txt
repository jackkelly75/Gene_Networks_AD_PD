...
discovery_network <- adjacency #(from MCI)
rm(adjacency)

setwd("E:/PhD work/Network analysis/Network Analysis AD/GSE63060 + GSE63061/2 WGCNA/AD")
load("adjacency.Rdata")
...
#import the modules
setwd("E:/PhD work/Network analysis/Network Analysis AD/GSE63060 + GSE63061/3 K-means correction of data/MCI")
load("adjusted_module_info.Rdata")
module_labels <- moduleColors ##from the MCI merged
...
setwd("E:/PhD work/Network analysis/Network Analysis AD/GSE63060 + GSE63061/4 Identify changed modules/Corrected/Lesser/MCI not preserved in AD")
